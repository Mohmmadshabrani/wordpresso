...
define('CREATIVE_PORTFOLIO_LITE_THEME_BUNDLE',__('https://www.misbahwp.com/themes/wordpress-bundle/','creative-portfolio-lite'));
}
		...
		<div id="righty">
			<div class="postbox donate">
				...
				<div class="inside theme-bundle">
					<p class="offer"><?php esc_html_e('Get 50+ Perfect WordPress Theme In A Single Package at just $79."','creative-portfolio-lite'); ?></p>
					<p class="coupon"><?php esc_html_e('Exclusive Offer !! Get Our Theme Pack of 60+ WordPress Themes At 10% Off','creative-portfolio-lite'); ?><span class="coupon-code"><?php esc_html_e('"Themespack10"','creative-portfolio-lite'); ?></span></p>
