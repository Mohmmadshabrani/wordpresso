	...
	<div class="container">
		...
		<div class="tab text-center">
	        <?php $creative_portfolio_lite_featured_post = get_theme_mod('creative_portfolio_lite_projects_number', '');
          		...
          		<button class="tablinks mr-2 mr-md-3" onclick="creative_portfolio_lite_projects_tab(event, '<?php $creative_portfolio_lite_main_id = get_theme_mod('creative_portfolio_lite_projects_text'.$creative_portfolio_lite_j); $creative_portfolio_lite_tab_id = str_replace(' ', '-', $creative_portfolio_lite_main_id); echo $creative_portfolio_lite_tab_id; ?> ')">
