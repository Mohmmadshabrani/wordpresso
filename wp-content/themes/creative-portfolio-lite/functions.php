...
function creative_portfolio_lite_global_color() {
	...
	';
    wp_add_inline_style( 'creative-portfolio-lite-style',$theme_color_css );
    wp_add_inline_style( 'creative-portfolio-lite-woocommerce-css',$theme_color_css );
...
if (!function_exists('creative_portfolio_lite_loop_columns')) {
	function creative_portfolio_lite_loop_columns() {
		$columns = get_theme_mod( 'creative_portfolio_lite_per_columns', 3 );
		return $columns;
	}
}
...
function creative_portfolio_lite_per_page( $cols ) {
  	$cols = get_theme_mod( 'creative_portfolio_lite_product_per_page', 9 );
	return $cols;
}
